...
This book is meant for you, the Dungeon Master, alone. We recommend you read the entire adventure before attempting to run it. It assumes that you have the fifth edition [Player’s Handbook](https://www.dndbeyond.com/sources/phb "Player’s Handbook"), [Dungeon Master’s Guide](https://www.dndbeyond.com/sources/dmg "Dungeon Master’s Guide"), and [Monster Manual](https://www.dndbeyond.com/sources/mm "Monster Manual").

The [Monster Manual](https://www.dndbeyond.com/sources/mm "Monster Manual") contains stat blocks for most of the monsters and nonplayer characters (NPCs) found in this adventure. Descriptions and stat blocks for new monsters and NPCs are provided in [appendix D](https://www.dndbeyond.com/sources/cos/appendix-d-monsters-and-npcs "appendix D"). When a creature’s name appears in **bold** type, that’s a visual cue pointing you to the creature’s stat block in the [Monster Manual](https://www.dndbeyond.com/sources/mm "Monster Manual"). If the stat block is in [appendix D](https://www.dndbeyond.com/sources/cos/appendix-d-monsters-and-npcs "appendix D"), the adventure’s text tells you so.

Spells and nonmagical equipment mentioned in the adventure are described in the [Player’s Handbook](https://www.dndbeyond.com/sources/phb "Player’s Handbook"). Magic items are described in the [Dungeon Master’s Guide](https://www.dndbeyond.com/sources/dmg "Dungeon Master’s Guide"), unless the adventure’s text directs you to an item’s description in [appendix C](https://www.dndbeyond.com/sources/cos/appendix-c-treasures "appendix C").

Text that appears in a box like this is meant to be read aloud or paraphrased for players when their characters first arrive at a location or under a specific circumstance, as described in the text. Indoor and nighttime descriptions are written with the assumption that the adventurers are using a torch or other light source to see by.### Story Overview
...
Much of the adventure’s action is driven by the clash between the adventurers’ decisions and Strahd’s goals, and the adventurers and the vampire are all caught in strands of fate that are represented by a special card reading detailed in [chapter 1](https://www.dndbeyond.com/sources/cos/into-the-mists#CardReading "chapter 1"), “Into the Mists.” Before you run the adventure, you need to conduct that reading to determine the location of several items that are key to the story, as well as one of the locations where Strahd can be found.

[Chapter 1](https://www.dndbeyond.com/sources/cos/into-the-mists "Chapter 1") also outlines Strahd’s goals, and it suggests adventure hooks to draw the player characters into the cursed realm of Barovia. If the characters are 1st level, the character background in [appendix A](https://www.dndbeyond.com/sources/cos/appendix-a-character-options "appendix A") is available to them, and consider starting their time in Barovia with the mini-adventure “Death House” in [appendix B](https://www.dndbeyond.com/sources/cos/appendix-b-death-house "appendix B").

[Chapter 2](https://www.dndbeyond.com/sources/cos/the-lands-of-barovia "Chapter 2"), “The Lands of Barovia,” provides an overview of the realm and includes special rules for it and its people, including the mysterious Vistani. Chapters 3–15 detail areas that correspond to places on the [map of Barovia](https://www.dndbeyond.com/sources/cos/the-lands-of-barovia#Map21Barovia "map of Barovia") in chapter 2.

The [epilogue](https://www.dndbeyond.com/sources/cos/epilogue "epilogue") offers ways for you to end the adventure. [Appendix C](https://www.dndbeyond.com/sources/cos/appendix-c-treasures "Appendix C") details the special items—magical or otherwise—introduced in the adventure, and [appendix D](https://www.dndbeyond.com/sources/cos/appendix-d-monsters-and-npcs "appendix D") provides stat blocks for Strahd and various NPCs and monsters that can be met in Barovia. [Appendix E](https://www.dndbeyond.com/sources/cos/appendix-e-the-tarokka-deck "Appendix E") shows the tarokka cards that the Vistani use for their fortune telling, and [appendix F](https://www.dndbeyond.com/sources/cos/appendix-f-handouts "appendix F") contains handouts for you to show the players.
...
**Finding Artifacts.** The characters gain a level when they obtain the  *Tome of Strahd* , the [Sunsword](https://www.dndbeyond.com/magic-items/5532-sunsword), or the [Holy Symbol of Ravenkind](https://www.dndbeyond.com/magic-items/5529-holy-symbol-of-ravenkind).

**Defeating Villains.** The characters gain a level when they defeat the featured antagonist(s) in a location, such as the hags in Old Bonegrinder ([chapter 6](https://www.dndbeyond.com/sources/cos/old-bonegrinder "chapter 6")).

**Accomplishing Story Goals.** The characters gain a level when they accomplish something significant, such lighting the beacon of Argynvostholt ([chapter 7](https://www.dndbeyond.com/sources/cos/argynvostholt "chapter 7")), thwarting the druids’ ritual atop Yester Hill ([chapter 14](https://www.dndbeyond.com/sources/cos/yester-hill "chapter 14")), or forging an alliance with Ezmerelda d’Avenir ([appendix D](https://www.dndbeyond.com/sources/cos/appendix-d-monsters-and-npcs#EzmereldadAvenir "appendix D")).

[Appendix B](https://www.dndbeyond.com/sources/cos/appendix-b-death-house "Appendix B"), “Death House,” uses milestone awards by way of example.

Be prepared for the fact that the adventure is exceedingly open-ended—one of the hallmarks of the original  *Ravenloft* . The card reading in [chapter 1](https://www.dndbeyond.com/sources/cos/into-the-mists#CardReading "chapter 1") and the adventurers’ choices can lead them all over the map, and a party can easily wander into an area well beyond their power. If you’d like to steer them toward places that correspond to their level, consult the Areas by Level table, but beware of undermining the sense that the characters’ choices matter. Sometimes the adventurers will simply need to flee or hide when they are out of their depth.

If an area of the adventure ends up feeling free of mystery or danger, consider using tips from the “[Marks of Horror](https://www.dndbeyond.com/sources/dnd/cos/introduction#MarksofHorror "Marks of Horror")” section to increase the ominousness. If a combat encounter feels too easy, either (a) guide it to its end as quickly as possible or (b) increase the threat by raising a foe’s hit point maximum to the upper end of its hit point range, by adding monsters/traps, or both.

**Areas by Level**

| Avg. Level | Area                   | Chapter                                                         |
| ---------- | ---------------------- | --------------------------------------------------------------- |
| 1st–3rd   | Village of Barovia     | [3](https://www.dndbeyond.com/sources/cos/the-village-of-barovia "3") |
| 4th        | Town of Vallaki        | [5](https://www.dndbeyond.com/sources/cos/the-town-of-vallaki "5")    |
| 4th        | Old Bonegrinder        | [6](https://www.dndbeyond.com/sources/cos/old-bonegrinder "6")        |
| 5th        | Village of Krezk       | [8](https://www.dndbeyond.com/sources/cos/the-village-of-krezk "8")   |
| 5th        | Wizard of Wines Winery | [12](https://www.dndbeyond.com/sources/cos/the-wizard-of-wines "12")  |
| 6th        | Van Richten’s Tower   | [11](https://www.dndbeyond.com/sources/cos/van-richtens-tower "11")   |
| 6th        | Yester Hill            | [14](https://www.dndbeyond.com/sources/cos/yester-hill "14")          |
| 7th        | Argynvostholt          | [7](https://www.dndbeyond.com/sources/cos/argynvostholt "7")          |
| 7th        | Werewolf Den           | [15](https://www.dndbeyond.com/sources/cos/werewolf-den "15")         |
| 8th        | Tsolenka Pass          | [9](https://www.dndbeyond.com/sources/cos/tsolenka-pass "9")          |
| 8th        | The Ruins of Berez     | [10](https://www.dndbeyond.com/sources/cos/the-ruins-of-berez "10")   |
| 9th        | Castle Ravenloft       | [4](https://www.dndbeyond.com/sources/cos/castle-ravenloft "4")       |
| 9th        | The Amber Temple       | [13](https://www.dndbeyond.com/sources/cos/the-amber-temple "13")     |
...
* Allow the character who has the highest passive Wisdom ([Perception](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) score to see, hear, or smell something that no one else can perceive.
